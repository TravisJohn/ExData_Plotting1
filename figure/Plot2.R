...
dataset <- read.csv2("YOUFILEPATH\\household_power_consumption.txt", header=T, sep=";")
...
par(mfrow = c(1,1))
####plot2
png("YOUFILEPATH\\plot2.png")
plot(wf1$DaysNTimes,wf1$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")
dev.off()